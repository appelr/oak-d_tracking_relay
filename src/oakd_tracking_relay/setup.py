    ...
    with OakD(config) as camera:
        ...
        while True:
            ...
            if eyeTracker.currentState == TrackerState.TRACKING and eyeTracker.stereoCoordinates.valid():
                iris3D = utils.triangulatePoints_CV(eyeTracker.stereoCoordinates)

                pointX, pointY = int(eyeTracker.stereoCoordinates.left.x), int(eyeTracker.stereoCoordinates.left.y)
